...
public class testCiudad {
    public static void main(String[] args) {
        ...
        final String txtRuta = "src/ciudades.txt";
        cargarArrCiudades(arrCiudades, longArr, txtRuta);
    ...
    public static void cargarArrCiudades(Ciudad[] arrCiudad, int longArr, String direccion){
        String lineaTxt;
        int i;
        try {
